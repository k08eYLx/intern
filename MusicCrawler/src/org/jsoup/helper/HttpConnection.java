...
public class HttpConnection implements Connection {
	...
	public static Connection connect(String url, Proxy proxy) {
        Connection con = new HttpConnection(proxy);
        con.url(url);
        return con;
    }
	...
	private HttpConnection(Proxy proxyObj) {
        req = new Request();
        res = new Response();
        proxy = proxyObj;
    }
    ...
    public Connection.Response execute() throws IOException {
        res = Response.execute(req, proxy);
        return res;
    }
    ...
    public static class Response extends Base<Connection.Response> implements Connection.Response {
        ...
        static Response execute(Connection.Request req, Proxy proxy) throws IOException {
            return execute(req, null, proxy);
        }

        static Response execute(Connection.Request req, Response previousResponse, Proxy proxy) throws IOException {
            ...
            HttpURLConnection conn = createConnection(req, proxy);
            Response res;
            try {
                conn.connect();
        ...
        private static HttpURLConnection createConnection(Connection.Request req, Proxy proxy) throws IOException {
