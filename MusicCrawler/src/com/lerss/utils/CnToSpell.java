...
/**
 *
 * 汉字（简体）转化为全拼,码表利用输入法的码表导出，汉字信息非常全，平时见到的汉字
...
public class CnToSpell {
     ...
     *
     * @param cn char 汉字字符
     * @return string 错误返回 空字符串,否则返回ascii（如：“好”返回“186-195”）
     */
    ...
    public static String getFullSpell(String cnStr){
        return getFullSpell(cnStr, false);
    }
     ...
     */
    public static String getFullSpell(String cnStr, boolean isGetMultiPrononce)
    {
        ...
        for (int i = 0, Len = chars.length; i < Len; i++) {
        	// 由于多音是按','分隔的，对','进行split然后再取index=0，会引发ArrayIndexOutOfBoundsException
        	if (chars[i] == ',') {    
            ...
            if (ascii.length() == 0) { // 取ascii时出错
                ...
                if (spell == null) {
                    ...
                    if(!isGetMultiPrononce) spell = spell.split(",")[0];
